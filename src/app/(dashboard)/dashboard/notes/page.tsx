...
const STATIC_TEMPLATES = [
  {
    slug: 'blank',
    label: 'Blank Note',
    desc: 'Start from a clean slate for custom research or unique drafting requirements.',
    category: '',
  },
  {
    slug: 'irac',
    label: 'IRAC Framework',
    desc: 'Master the standard method for legal analysis: Issue, Rule, Application, and Conclusion.',
    category: 'ACADEMIC',
    featured: true,
  },
  {
    slug: 'case-brief',
    label: 'Case Brief',
    desc: 'Summarize judicial opinions, procedural history, and core legal holdings.',
    category: 'RESEARCH',
  },
  {
    slug: 'statute',
    label: 'Statute Summary',
    desc: 'Concise breakdown of legislative Acts, provisions and effective dates.',
    category: 'COMPLIANCE',
  },
  {
    slug: 'research',
    label: 'Research Memo',
    desc: 'Draft internal office memo with proper citation, legal questions, and actionable findings.',
    category: 'INTERNAL',
  },
  {
    slug: 'lecture',
    label: 'Lecture Notes',
    desc: 'Streamlined layout for law school lectures or legal seminar tracking.',
    category: 'EDUCATION',
  },
] as const;
...
export default function NotesPage() {
  ...
  async function handleCreateFromSlug(slug: TemplateSlug) {
    ...
    try {
      ...
      const apiMatch = apiTemplates.find(
        (t) =>
          t.name.toLowerCase().includes(slug.replace('-', ' ')) ||
          t.category?.toLowerCase() === slug
      );
          ...
          <section>
            ...
            <div className={styles.recommendedRow}>
              ...
              <button
                ...
                onClick={() => handleCreateFromSlug('blank')}
                disabled={creating}
              >
                ...
                <span className={styles.blankDesc}>
                  Start from a clean slate for custom research or unique drafting requirements.
                </span>
              ...
              <div className={styles.featuredCard}>
                ...
                <div className={styles.featuredBody}>
                  ...
                  <p className={styles.featuredDesc}>
                    Master the standard method for legal analysis: Issue, Rule, Application, and
                    Conclusion. Perfect for law school and legal practice.
                  </p>
                  <button

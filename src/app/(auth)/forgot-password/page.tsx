...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.success) { setFormError(res.message ?? res.error ?? 'Could not send reset link.'); return; }
    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <div className={styles.formWrap}>
          ...
          <p className={styles.sub}>Hi there, not too worry — we can help you recover your password.</p>

...
export default function LectureNotesForm({
  title,
  content,
  onSave,
  pendingInsert,
  ...
  const M = [
    {
      label: 'COURSE TITLE / CODE',
      value: courseTitle,
      set: (v: string) => {
        setCourseTitle(v);
        save(nt, v, lecturer, date, topicWeek, keyConcepts, lectureFlow, marginNotes, examPointers);
      },
      placeholder: 'E.g LAW 302 / tort law',
    },
    {
      label: 'LECTURER',
      value: lecturer,
    ...
    },
    {
      ...
      placeholder: 'E.g Tort law week 2',
    },
  ];
    ...
    <div className={styles.form}>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHead}>
          <span className={styles.sectionLabel}>KEY CONCEPT COVERED</span>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHead}>
          <span className={styles.sectionLabel}>LECTURE FLOW</span>
          <span className={styles.sectionLine} />
        </div>
        <textarea
      ...
      <div className={styles.section}>
        <div className={styles.sectionHead}>
          <span className={styles.sectionLabel}>MARGIN NOTES</span>
          <span className={styles.sectionLine} />
        </div>
        <textarea
          className={styles.sectionTextarea}
      ...
      <div className={styles.section}>
        <div className={styles.sectionHead}>
          <span className={styles.sectionLabel}>EXAM POINTERS</span>
          <span className={styles.sectionLine} />
        </div>
        {examPointers.map((v, i) => (
          <div key={i} className={styles.listItem}>
            <input
              ...
              value={v}
              onChange={(e) => {
                const n = examPointers.map((x, j) => (j === i ? e.target.value : x));
                setExamPointers(n);
                save(
                  nt,
                  courseTitle,
            ...
            <button
              ...
              type="button"
              onClick={() => {
                const n = examPointers.filter((_, j) => j !== i);
                setExamPointers(n);
                save(
                  nt,
                  courseTitle,

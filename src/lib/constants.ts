...
export const NLS_CAMPUSES = [
  'NLS — Lagos Campus (Victoria Island, Lagos)',
  'NLS — Abuja Campus (Bwari, FCT)',
  'NLS — Enugu Campus (Agbani Road, Enugu)',
  'NLS — Kano Campus (Bagauda, Kano)',
  'NLS — Yola Campus (Jimeta, Adamawa)',
  'NLS — Yenagoa Campus (Yenagoa, Bayelsa)',
  'NLS — Port Harcourt Campus (Port Harcourt, Rivers)',
] as const;
